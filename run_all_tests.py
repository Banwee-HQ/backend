...
TEST_INVENTORY = {
    ...
    "Wishlist (6)": [
        ("069", "GET /v1/wishlists/ - List wishlists"),
        ("070", "POST /v1/wishlists/ - Create wishlist"),
        ("071", "GET /v1/wishlists/{id} - Get wishlist"),
        ("072", "PATCH /v1/wishlists/{id} - Update wishlist"),
        ("073", "DELETE /v1/wishlists/{id} - Delete wishlist"),
        ("074", "POST /v1/wishlists/{id}/items - Add item to wishlist"),
    ],
    "Cart (8)": [
    ...
    "Inventory (14)": [
        ...
        ("130", "POST /v1/inventory/adjust - Adjust stock"),
    ...
    "Tax (6)": [
        ...
        ("157", "POST /v1/tax/admin/tax-rates - Create tax rate (admin)"),
