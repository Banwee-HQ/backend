...
Revision ID: a48bb2d70078
Revises: 
Create Date: 2026-03-23 17:09:36.344882
...
def upgrade() -> None:
    ...
    op.create_index('idx_users_email_account_status', 'users', ['email', 'account_status'], unique=False)
    op.create_index('idx_users_last_login', 'users', ['last_login'], unique=False)
    op.create_index('idx_users_role_verification_status', 'users', ['role', 'verification_status'], unique=False)
    ...
    sa.ForeignKeyConstraint(['discount_id'], ['promocodes.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index('idx_users_role_verification_status', table_name='users')
    op.drop_index('idx_users_last_login', table_name='users')
    op.drop_index('idx_users_email_account_status', table_name='users')
